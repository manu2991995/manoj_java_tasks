...
public class Class2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Adavance_java_individual_tasks_givenby_praveen.Car brand : " + class2.getBrand());
        System.out.println("Adavance_java_individual_tasks_givenby_praveen.Car mfg year: " + class2.getYear());
