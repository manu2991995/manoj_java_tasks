...
//1st interface --> Advance_java_group_tasks_givenby_praveen.iVolumeControl
    @Override
    ...
    public static void main(String[] args) {
       ...
       smartTv.averageVolume();
        ...
        //2nd interface --> Advance_java_group_tasks_givenby_praveen.iChannelControl
        smartTv.nextChannel();
        ...
        //4th interface --> Advance_java_group_tasks_givenby_praveen.iConnectivity
        smartTv.connectToWiFi();
        smartTv.pairBluetoothDevice();
        smartTv.enableScreenMirroring();

        //5th interface --> Advance_java_group_tasks_givenby_praveen.iMediaControl
        smartTv.playMedia();
        smartTv.stopMedia();
        smartTv.enableScreenMirroring();
